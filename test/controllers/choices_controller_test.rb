...
class ChoicesControllerTest < ActionController::TestCase
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post :create, choice: { action: @choice.action, restaurant_id: @choice.restaurant_id, search_id: @choice.search_id, user_id: @choice.user_id }
    end
  ...
  test "should update choice" do
    patch :update, id: @choice, choice: { action: @choice.action, restaurant_id: @choice.restaurant_id, search_id: @choice.search_id, user_id: @choice.user_id }
    assert_redirected_to choice_path(assigns(:choice))
  end
